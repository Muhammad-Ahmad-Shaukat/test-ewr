   ...
   <section className="lg:pt-[177px] md:pt-[165px] pt-[140px] lg:pb-[96px] md:pb-[70px] pb-[50px] xl:px-[0px] px-[30px]">
    <div className='w-[100%] max-w-[1216px] mx-auto'>
        <div className='flex lg:flex-row flex-col-reverse lg:px-[50px] md:px-[30px] px-[20px] justify-between lg:gap-[20px] gap-[0px] shadow-[0_0_15px_rgba(0,0,0,0.1)] rounded-[16px]'>
             <div className='flex flex-col w-[100%] max-w-[416px] lg:pt-[50px] pt-[0px] lg:pb-[100px] pb-[20px]  items-start'>
                ...
                <div className="w-full max-w-[552px] relative lg:h-[300px] md:h-[296px] sm:h-[200px] h-[180px] lg:mx-[0px] mx-auto">
                <Image
                    src="/trusted.png"
                    alt="trusted"
                    width={500}
                    height={400}    
                  className="object-contain absolute top-[-100px] w-[100%] lg:max-w-[100%] md:max-w-[450px] sm:max-w-[300px] max-w-[300px] lg:right-0 lg:translate-x-0 right-1/2 translate-x-1/2"
                />
                </div>
