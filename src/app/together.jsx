...
<section className='pt-[70px]'>
        <h2 className='lg:text-[42px] md:text-[38px] text-[32px] font-semibold leading-[114%] text-[#131316] lg:mt-[17px] text-center mb-[20px]'>Faster, Better, Together</h2>
      <p className='md:text-[18px] text-[16px]  font-normal leading-normal w-[100%] max-w-[716px] mx-auto text-[#131316] lg:mb-[40px] md:mb-[32px] mb-[28px] text-center'>Our diverse team works in your time zone and brings proven expertise across industries
