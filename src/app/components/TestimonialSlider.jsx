...
export default function TestimonialSlider() {
  ...
  return (
    <div className="flex flex-col testimonial-layout gap-[37px] items-start">
      ...
      <div className="flex-1 w-full order-1 main-container lg:px-[0px] px-[20px] ">
        <Swiper
          onSwiper={(swiper) => {
        ...
        >
          {testimonials.map((item, i) => (
            <SwiperSlide key={i} className="!h-auto">
              <div className="bg-[#F5F5F5] rounded-[20px] lg:py-[49px] md:py-[40px] py-[30px] lg:px-[39px] md:px-[30px] px-[20px] transition-transform duration-500">
                ...
                <p className="lg:text-[23.5px] md:text-[21px] text-[18px] max-w-[792px] font-medium text-[#737373] leading-[130%] lg:mb-[50px] md:mb-[35px] mb-[28px] lg:mt-[50px] md:mt-[35px] mt-[28px]">
                  "{item.text}"
                </p>
                <div className="flex items-end">
                  <span className="lg:text-[102px] md:text-[80px] text-[64px] leading-[85%] text-[#080808] font-medium">{Number(item.rating).toFixed(1)} </span>
                  {[...Array(5)].map((_, j) => (
                    <svg
                      key={j}
